...
parser.add_argument('--exp_name', type=str, default='/scratch/users/haipeng/Anomaly-Vp-Vs-Den')
...
if generate_data:
    ...
    # load true model
    vp_true  = np.loadtxt('./Models/Anomaly_P-WAVE_VELOCITY_101_201.txt').astype('float32')
    vs_true  = np.loadtxt('./Models/Anomaly_S-WAVE_VELOCITY_101_201.txt').astype('float32')
    den_true = np.loadtxt('./Models/Anomaly_DENSITY_101_201.txt').astype('float32')
...
## Full Waveform Inversion
    ...
    # load initial model
    vp_init  = np.loadtxt('./Models/Anomaly_P-WAVE_VELOCITY_101_201_init.txt').astype('float32')
    vs_init  = np.loadtxt('./Models/Anomaly_S-WAVE_VELOCITY_101_201_init.txt').astype('float32')
    den_init = np.loadtxt('./Models/Anomaly_DENSITY_101_201_init.txt').astype('float32')
