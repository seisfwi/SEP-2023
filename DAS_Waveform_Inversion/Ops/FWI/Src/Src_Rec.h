...
class Src_Rec {
 ...
 public:
  ...
  std::vector<float *> vec_data_vx;
  std::vector<float *> vec_data_vz;
  std::vector<float *> vec_data_ett;
  std::vector<float *> vec_data_adj;
  std::vector<float *> vec_data_obs;
  std::vector<float *> vec_data_obs_vx;
  std::vector<float *> vec_data_obs_vz;
  std::vector<float *> vec_data_obs_ett;
  std::vector<float *> vec_res;     // host side data residual
  std::vector<float *> vec_res_vx;  // host side data residual
  std::vector<float *> vec_res_vz;  // host side data residual
  std::vector<float *> vec_res_ett; // host side data residual
